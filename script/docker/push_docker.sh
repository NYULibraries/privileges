...
docker tag privileges_test quay.io/nyulibraries/privileges_test:latest
docker tag privileges_test quay.io/nyulibraries/privileges_test:${CIRCLE_BRANCH//\//_}
docker tag privileges_test quay.io/nyulibraries/privileges_test:${CIRCLE_BRANCH//\//_}-${CIRCLE_SHA1}
