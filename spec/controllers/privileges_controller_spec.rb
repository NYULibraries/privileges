...
describe PrivilegesController do
  ...
  describe '#index_patron_statuses' do
    ...
    context "when user signed in" do
      ...
      xit { is_expected.to redirect_to redirect_path }
      xit "should assign patron_status" do
  ...
  xdescribe '#show_patron_status' do
    ...
    context 'when there is no sublibrary code' do
      it 'should set up variables' do
        ...
        # expect(assigns(:sublibraries_with_access)).to_not be_nil
    ...
    context 'when there is a sublibrary code provided' do
      let(:sublibrary_code) { create(:sublibrary).code }
      it 'should set up variables' do
